...
> Design notes for **edtech-receipt-delivery-service** — a runnable typescript example that Typed Node service that emails course receipts, computes learner deadlines, and records delivery for educator reports.
...
- **Feature code** — the actual task: course-receipt-reporting.
